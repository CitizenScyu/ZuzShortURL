    ...
    <main class="main-content flex items-center justify-center">
        <div class="max-w-md w-full p-4">
            <div class="bg-card rounded-lg border p-6">
                <h2 class="text-2xl font-bold mb-4 text-center">创建您的账户</h2>
                <?php if ($error): ?>
                ...
                <form method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="confirm_password" class="w-full px-3 py-2 border border-input rounded-md bg-transparent" required>
                    </div>
                    ...
                    <?php endif; ?>
                    <button type="submit" class="w-full bg-primary text-primary-foreground py-2 rounded-md hover:bg-primary/90 mt-3">注册</button>
                </form>
                <p class="mt-4 text-center text-sm text-muted-foreground">已有账号？ <a href="/login" class="underline">登录</a></p>
            </div>
        </div>
    </main>
